...
@admin.register(Etudiantt)
class EtudianttAdmin(admin.ModelAdmin):
    list_display=('nom','prenom','option')
    list_filter = ('classe',)
#admin.site.register(Etudiantt,EtudianttAdmin)
admin.site.register(Option)
#admin.site.register(Etudiantt,AdminEtudiantt)